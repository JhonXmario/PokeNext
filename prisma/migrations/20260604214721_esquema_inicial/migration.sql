...
CREATE TABLE "favorites" (
    ...
    "pokemon_sprite" TEXT,
    "pokemon_types" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "favorites_pkey" PRIMARY KEY ("user_id","pokemon_id")
);
...
-- CreateIndex
CREATE INDEX "team_pokemons_team_id_idx" ON "team_pokemons"("team_id");

-- CreateIndex
CREATE UNIQUE INDEX "team_pokemons_team_id_order_key" ON "team_pokemons"("team_id", "order");
